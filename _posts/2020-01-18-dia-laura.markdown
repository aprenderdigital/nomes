...
<div class="inner">
							<h2>Compartilhar <i>banner</i> com o nome d{{page.artigo}} {{page.title}}</h2>
							<button type="button" class="btn btn-primary small" onclick="shareFacebook()">
								<i class="fa fa-facebook-official" aria-hidden="true">
								</i>&nbsp;&nbsp;Compartilhar NOME no Facebook</button>
							<br /> <br />
							<button type="button" class="btn btn-success small" onclick="shareWhatsApp()">
								<i class="fa fa-whatsapp" aria-hidden="true">
								</i>&nbsp;&nbsp;Compartilhar NOME no WhatsApp
							</button>
</div>
